...
foreach ($name in @('README.md', 'README.zh-CN.md', 'LICENSE', 'CHANGELOG.md')) { Copy-Item -LiteralPath (Join-Path $projectRoot $name) -Destination $releasePath -Force }
...
$releaseFiles = @('Tomato.exe', 'Tomato.exe.config', 'README.md', 'README.zh-CN.md', 'LICENSE', 'CHANGELOG.md', 'VALIDATION.md', 'preview.png')
